...
urlpatterns = [
    ...
    # # /proyecto/1/update/
    # url(r'^task/(?P<pk>[0-9]+)/update/$', views.ProyectoUpdate.as_view(), name='proyecto_update'),

    # # /proyecto/1/delete/
    # url(r'^task/(?P<pk>[0-9]+)/delete/$', views.ProyectoDelete.as_view(), name='proyecto_delete'),
]